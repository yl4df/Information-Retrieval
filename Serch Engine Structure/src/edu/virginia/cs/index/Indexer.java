...
public class Indexer {
    ...
    public static void index(String indexPath, Corpus corpus)
        ...
        for(i=0; i<corpus.getCorpusSize(); i++) {
            ...
            doc.add(new Field("author", review.getAuthor(), _contentFieldType));//the author field is searchable
            doc.add(new Field("content", review.getContent(), _contentFieldType));//the content field is searchable
